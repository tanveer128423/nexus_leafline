...
class _EditPlantScreenState extends State<EditPlantScreen>
  ...
  void initState() {
    ...
    _wateringController = TextEditingController(text: widget.plant.watering);
    _sunlightController = TextEditingController(text: widget.plant.sunlight);
    _soilController = TextEditingController(text: widget.plant.soil);
    _careInstructionsController = TextEditingController(
      text: widget.plant.careInstructions.join('\n'),
    );
    _selectedCategoryId = widget.plant.categoryId;
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(
                                    color: Color(0xFFFFB444).withOpacity(0.2),
                                    width: 1,
                                  ),
                                ),
                                child: Wrap(
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  boxShadow: [
                                    BoxShadow(
                                      color: Color(0xFFFFB444).withOpacity(0.4),
                                      blurRadius: 20,
                                      offset: Offset(0, 10),
                                    ),
                                  ],
          ...
          child: TextFormField(
            ...
            decoration: InputDecoration(
              ...
              prefixIcon: Padding(
                ...
                child: Icon(
                  icon,
                  color: Color(0xFFFFB444).withOpacity(0.7),
                  size: 22,
                ),
              ),
